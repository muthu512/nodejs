pipeline {
    ...
    environment {
        PROJECT_DIR = "C:\\Users\\Dell-Lap\\Downloads\\simple-reactjs-app-master\\simple-reactjs-app-master"
    ...
    stages {
        ...
        stage('Checkout SCM') {
            steps {
                script {
                    git credentialsId: 'muthu512', url: 'https://github.com/muthu512/nodejs', branch: 'master'
